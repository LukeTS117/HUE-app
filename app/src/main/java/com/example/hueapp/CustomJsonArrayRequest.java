...
public class CustomJsonArrayRequest extends JsonRequest<JSONArray> {
    ...
    public CustomJsonArrayRequest(int method, String url, @Nullable JSONObject requestBody, Response.Listener<JSONArray> listener, Response.ErrorListener errorListener) {
        super(  method,
                url,
